        	...
        	<div id="content_section">
				...
				<!-- Col1 -->
                	<div class="col1">
                    	<!-- Banner -->
                        	<div id="banner1">
									           <a href="#"><img src="<?php echo base_url().'template/images/banner2.png'?>" alt="" /></a>
                                <div class="heading">
                         ...
                         <!-- Content Heading -->
                         	<div id="content2">	
                                ...
                                <?php
                                  ...
                                  ?>
                                	<li>
                                		<div class="thumb"><a href="<?php echo base_url().'berita/berita_detail/'.$tulisan_id;?>"><img width="126" height="66" src="<?php echo base_url().'assets/images/'.$tulisan_gambar;?>"  alt="" /></a></div>
                            ...
                            <!-- Recent Blog Top Rating -->  
                                 ...
                                 <div class="course_right">
                                  <div class="crheading" style="background-color:#92cc47;">
                                    ...
                                    <ul>
                                      <?php 
                                          $query=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_tulisan where tulisan_img_slider='0' ORDER BY tulisan_views DESC limit 7");
