...
<header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><img width="50" src="<?php echo base_url().'assets/images/sit.gif'?>"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img width="200" src="<?php echo base_url().'assets/images/sienta5.gif'?>"></span>
    </a>
