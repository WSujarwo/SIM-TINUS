...
<head>
  ...
  <title>Tinus | Data User Siswa</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active">
          <a href="<?php echo base_url().'admin/usersiswa'?>">
            <i class="fa fa-users"></i> <span>User Siswa</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
				...
				<?php foreach ($data->result_array() as $i) :
                       ...
                       $siswa_jenkel=$i['siswa_jenkel'];
                       $siswa_email=$i['siswa_email'];
                       $siswa_username=$i['siswa_username'];
                       $siswa_password=$i['siswa_password'];
                       $siswa_nohp=$i['siswa_nohp'];
                       $siswa_level=$i['siswa_level'];
                       $siswa_poto=$i['siswa_poto'];
                    ?>
                <tr>
                  <td><img width="40" height="40" class="img-circle" src="<?php echo base_url().'assets/img/'.$siswa_poto;?>"></td>
                  <td><?php echo $siswa_nama;?></td>
                  <td><?php echo $siswa_email;?></td>
                  <?php if($siswa_jenkel=='L'):?>
                        <td>Laki-Laki</td>
                  <?php else:?>
                        <td>Perempuan</td>
                  <?php endif;?>
                  <td><?php echo $siswa_password;?></td>
                  <td><?php echo $siswa_nohp;?></td>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $siswa_id;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" href="<?php echo base_url().'admin/usersiswa/reset_password/'.$siswa_id;?>"><span class="fa fa-refresh"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $siswa_id;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
                </tbody>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="#">Pewe Sujarwo</a>.</strong> All rights reserved.
  </footer>
...
<!--Modal Add Pengguna-->
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/usersiswa/simpan_usersiswa'?>" method="post" enctype="multipart/form-data">
		...
		<?php foreach ($data->result_array() as $i) :
            ...
            ?>
	<!--Modal Edit Pengguna-->
        <div class="modal fade" id="ModalEdit<?php echo $siswa_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-4 control-label">Email</label>
                                        <div class="col-sm-7">
                                            <input type="email" name="xemail" class="form-control" value="<?php echo $siswa_email;?>" id="inputEmail3" placeholder="Email" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Jenis Kelamin</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Username</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xusername" class="form-control" value="<?php echo $siswa_username;?>" id="inputUserName" placeholder="Username" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Password</label>
	...
	<!--Modal Hapus Pengguna-->
        <div class="modal fade" id="ModalHapus<?php echo $siswa_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/usersiswa/hapus_usersiswa'?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">       
							<input type="hidden" name="kode" value="<?php echo $siswa_id;?>"/> 
                            <p>Apakah Anda yakin mau menghapus User <b><?php echo $siswa_nama;?></b> ?</p>
...
<?php if($this->session->flashdata('msg')=='error'):?>
    ...
    <?php elseif($this->session->flashdata('msg')=='success'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "User Siswa Berhasil disimpan ke database.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='info'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Info',
                    text: "User Siswa berhasil di update",
                    showHideTransition: 'slide',
                    icon: 'info',
                    hideAfter: false,
                    position: 'bottom-right',
    ...
    <?php elseif($this->session->flashdata('msg')=='success-hapus'):?>
        <script type="text/javascript">
                $.toast({
                    heading: 'Success',
                    text: "User Siswa Berhasil dihapus.",
                    showHideTransition: 'slide',
                    icon: 'success',
                    hideAfter: false,
                    position: 'bottom-right',
