...
<head>
  ...
  <title>Tinus | Data Pengumuman</title>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                  <textarea class="form-control" rows="3" name="xlink" placeholder="Link PDF..." required></textarea>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="inputUserName" class="col-sm-4 control-label">Link</label>
                                <div class="col-sm-7">
                                  <textarea class="form-control" rows="3" name="xlink" placeholder="Link PDF ..." required><?php echo $link;?></textarea>
                                </div>
                            </div>
